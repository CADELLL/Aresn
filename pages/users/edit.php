...
<form action="" method="POST">
    ...
    <table class="table">
        ...
        <tr>
            ...
            <td>
                <input type="text" name="kataSandi" class="input-form" id="kataSandi" placeholder="Masukkan kata sandi!" value="<?= $pengguna['kata_sandi'] ?>" autocomplete="off" min="3" required>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="2" style="text-align: center;"><button type="submit" name="edit" class="button yellow">Edit</button></td>
        </tr>
    </table>
</form>
