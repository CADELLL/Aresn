...
<table class="table">
    ...
    <?php foreach ($pengumuman as $p) : ?>
        <tr>
            ...
            <td><?= $p['tanggal']; ?></td>
            <td>
                <a href="detail.php?i=<?= $p['id'] ?>" class="badge grey">Detail</a>
                <a href="delete.php?i=<?= $p['id'] ?>" class="badge red" onclick="return confirm('Apakah yakin menghapus data pengumuman <?= $p['judul'] ?>?')">Hapus</a>
            </td>
        </tr>
    <?php endforeach; ?>
    <?php if ($pengumuman == []) : ?>
