<div id="sidebar">
    ...
    <ul>
        <?php if (!isset($_SESSION['payment'])) : ?>
            ...
            <li><a href="<?= locationFile(); ?>general" class="<?= activeMenu('general'); ?>"><span class="hide">SPP </span><i class='bx bxs-school hide-icon'></i></a></li>
        <?php endif; ?>
        <?php if (isset($_SESSION['admin'])) : ?>
            ...
            <li><a href="<?= locationFile(); ?>user" class="<?= activeMenu('user'); ?>"><span class="hide">Pengguna </span><i class='bx bxs-user-account hide-icon'></i></a></li>
            ...
            <li><a href="<?= locationFile(); ?>donation" class="<?= activeMenu('donation'); ?>"><span class="hide">SPP </span><i class='bx bxs-school hide-icon'></i></a></li>
        <?php endif; ?>
